...
While it is heavily "inspired" by the SCUMM engine, it isn't strictly a true replica (for that you'll want good ol' [SCUMM-VM](https://en.wikipedia.org/wiki/ScummVM)).  However, SCUMM-8 attempts to stay as true as possible to the original SCUMM API.
