				...
				function()
					...
					cutscene(cut_noverbs + cut_hidecursor, 
						function()
							-- part 1
							-- printh("1")
							-- print_line("in a galaxy not far away...",64,40,8,1)
							-- wait_for_message()
							...
							print_line("and swimming pools!",90,20,8,1)
							wait_for_message()

							wait_for_camera()
							print_line("*quack*",40,55,10,1)
							wait_for_message()
						end)
					...
					cutscene(cut_noverbs + cut_hidecursor, 
						function()
							printh("2")
							print_line("coming soon to a pico-8 near you...",64,40,8,1)
							wait_for_message()
							fades(1,1)
							break_time(1000)
						end)
