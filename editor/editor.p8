...
gui_tabs_value = 0
gui_tabs_func = nil
gui_tabs_start_hl = 268--12
gui_tabs_start_dk = 284--28
...
function _init()
  ...
  set_data_defaults()
	...
	--cstore(0,0,0x800) -- (test) save gfx (1st page)


  -- load gfx + map from current "disk" (e.g. base cart)
	 reload(0,0,0x1fff, base_cart_name..".p8") -- all 4 gfx pages
...
function spr_ex(spritenum, x, y)
	-- check for null
	spritenum = spritenum or 281
	if spritenum < 256 then
		-- draw as normal
		spr(spritenum,x,y)
	else
		-- draw from extended memory
		spritenum -= 256
...
function create_header()
	...
	if pnl_prop_header then
		...
		for w in all(pnl_prop_header.children) do
			pnl_prop_header:remove_child(w)
		end
	else
...
function create_ui_props() --pagenum)
	...
	local ico_spr = nil
	local ico_trans = 20 -- fake trans col to get all colors shown!
	if curr_selection_class != "class_room" then
		if curr_selection.states then
			ico_spr = curr_selection.states[curr_selection.state]
		end
	else
		ico_spr = 259
		ico_trans = 0
	end
	local ico_selected = icon.new(ico_spr or 281, nil)
...
-- map cel pos/size
	elseif datatype == 15 then
		local move_map = function(index, dir)
			room_curr.map[index] += dir
			-- redraw properties
			create_ui_props()
		end
	  -- pos information
		...
		btn_lt.desc = "move room map left"
		parent:add_child(btn_lt, x+0, y+10)
		-- move up
		local btn_up = icon.new(264, 0, function()
			move_map(2, -1)
		end)
		...
		btn_rt.desc = "move room map right"
		parent:add_child(btn_rt, x+10, y+10)
		-- move down
		local btn_dn = icon.new(265, 0, function()
			move_map(2, 1)
		end)
...
function create_more_button(parent, tooltip, bound_obj, bound_prop, x, y, func)
	local btn_more = button.new(282, func)
		btn_more.w=9
		btn_more.h=5
		...
		-- set nested "icon"'s trans color
		btn_more.children[1].trans = 8
	...
	if gui_tabs_visible then
		for i = 0,3 do
			if i == gui_tabs_value then
				spr_ex(gui_tabs_start_hl+i, 96+(i*8), 74)
			else
...
function object_draw(obj)
	...
	if not obj.state then
		--obj.draw(obj)
		palt(0,false)
		spr_ex(281, obj.x, obj.y + stage_top)
		pal()
		return
	else
		-- allow for repeating
...

...

...

__music__
00 41424344
00 41424344
00 41424344
