...
function stop_actor(actor)
 ...
 -- no need to do_anim(idle) here, as actor_draw code handles this
	clear_curr_cmd()
end
   ...
   -- force repaint of command (to reflect default verb)
	...
	if noun1_curr then
		...
		if vc2 == "use" or vc2 == "give" then
			if noun2_curr then
				-- 'use' part 2
			elseif noun1_curr.use_with and noun1_curr.owner == selected_actor then
...
function check_collisions()
 -- check for current room
    ...
    or max(obj.z,hover_curr_object.z) == obj.z
			then
